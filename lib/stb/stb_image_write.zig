...
pub const _SECIMP = @compileError("unable to translate macro: undefined identifier `dllimport`"); // C:\Program Files\zig\zig-windows-x86_64-0.12.0-dev.3180+83e578a18\lib\libc\include\any-windows-any/stdlib.h:22:9
